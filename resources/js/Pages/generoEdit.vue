...
const form = useForm({
    generoLit: props.genero.generoLit
})

const submit = () => {
    form.put(`/generos/${props.genero.id}`)
}
...
<template>
    <div class="container mx-auto p-4 md:p-6">
        <div class="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
            ...
            <h1 class="text-2xl md:text-3xl font-extrabold text-blue-600 dark:text-blue-400">Editar Género</h1>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    <div>
                        ...
                        <input 
                            ...
                            class="w-full p-3 border rounded-lg dark:bg-gray-700 dark:text-white border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition" 
                        />
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 pt-4">
                        ...
                        >
                            {{ form.processing ? 'Guardando...' : 'Actualizar género' }}
                        </button>
                    </div>
                </form>
            </div>
